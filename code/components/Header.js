...
// export default function Header(navLinks, activeLink, setActiveLink) {
...
//                       : 'text-white-100 hover:text-primary-600'
//                   }`}
...
//             whileTap={{ scale: 0.9 }}
//             className="md:hidden p-2 rounded-full bg-primary-50 text-primary-600"
...
//               className="md:hidden absolute top-20 left-0 right-0 bg-white/95 backdrop-blur-lg shadow-lg rounded-b-2xl border-t border-gray-100"
//             >
